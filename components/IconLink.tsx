...
export default function IconLink({ type, label, url }: IconLinkProps) {
  ...
  return (
    <a
      ...
      className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm text-zinc-700 bg-white border border-zinc-300 rounded-md hover:border-primary hover:text-primary hover:bg-zinc-50 focus-ring transition-all"
